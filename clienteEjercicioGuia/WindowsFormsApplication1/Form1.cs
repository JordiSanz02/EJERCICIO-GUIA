...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            IPEndPoint ipep = new IPEndPoint(direc,9160);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                //Enviamos nombre y palabra palindroma
                string mensaje = "4/" +Palindrome.Text;
                ...
                if (mensaje == "SI")
                    MessageBox.Show("Tu palabra es Palindroma.");
                else
                    MessageBox.Show("Tu nombre NO es Palindroma. Lo siento.");
            }
        ...
        private void Palindrome_TextChanged(object sender, EventArgs e)
        {
